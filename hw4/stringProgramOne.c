...
#include <stdlib.h>
 /*
This program will repeatedly ask for two strings as lines of text, ten removes the new line character
tjem reports the length of the lines, prints the lines back in lexical order, and determines and reprts whether either is a substring of the other
...
{
   char stringOne[1000], stringTwo[1000]; // you use 2 strings in this
   int quit=1; 
   ...
   while(quit==1)
   {
	   ...
	   fgets(stringOne, 1000, stdin);//get orignal string
	   ...
	   if(stringOne=="please**" && stringTwo=="quit**"
	   {
	      quit=1203;
	   }
   }
